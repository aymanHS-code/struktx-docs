...
<Note>
  Builder progressively injects <code>
  llm</code>
  ...
  store</code>
   ...
   into factories if their signatures accept them. Additional <code>
  params</code>
...
<Info>
  ...
  , all LLM calls receive relevant memory snippets automatically. Provide <code>
  context</code>
