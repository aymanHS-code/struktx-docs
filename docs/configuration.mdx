...
<Info>
  StruktX uses a flexible factory-based configuration system. You can pass factories as callables, classes, instances, or import strings like `"module:attr"`. Plain dicts for component configs are also accepted and coerced into dataclasses.
</Info>
...
```python
middleware=[
    MiddlewareConfig("your.own.middleware:AuthMiddleware", params={"valid_tokens": {"token1", "token2"}}),
    MiddlewareConfig("your.own.middleware:RateLimitMiddleware", params={"max_requests": 10, "window_seconds": 60}),
