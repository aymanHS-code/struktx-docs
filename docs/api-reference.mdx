...
<Note>
  You can pass LangChain chat models directly via `LLMClientConfig(factory="langchain_openai:ChatOpenAI", params={...})`. StruktX will adapt them automatically.
</Note>
...
```python
class UpstashVectorMemoryEngine:
